...
public class QuestionDBOpenHelper extends SQLiteOpenHelper {
    ...
    private static final int EASY_DATABASE_VERSION = 40;
    private static final int MEDIUM_DATABASE_VERSION = 50;
    // Database Name
    ...
    public QuestionDBOpenHelper(Context context) {
        super(context, DATABASE_NAME, null, EASY_DATABASE_VERSION);
    }
    ...
    private void addQuestion() {
        ...
        for (int i = 0; i < entireNumberOfQuestions; i++) {
            numberOfQuestions[i] = new EasyRandom();
            addQuestion(numberOfQuestions[i]);
        }
